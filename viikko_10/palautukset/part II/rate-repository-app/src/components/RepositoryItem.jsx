...
const RepositoryItem = props => {
    console.log("Creating repositoryItem");
...
<Text style={styles.test2}>{props.item.language}</Text>
<Text style={{fontWeight: "bold"}}>{stars}</Text>
<Text>Stars</Text>
<Text style={{fontWeight: "bold"}}>{forks}</Text>
<Text>Forks</Text>
<Text style={{fontWeight: "bold"}}>{props.item.reviewCount}</Text>
<Text>Reviews</Text>
<Text style={{fontWeight: "bold"}}>{props.item.ratingAverage}</Text>
<Text>Rating</Text>
*/